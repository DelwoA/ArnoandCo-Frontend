...
const TermsAndConditionsPage = () => {
  ...
  useEffect(() => {
    document.title = "Terms & Conditions — Arno & Co.";
  }, []);
          ...
          <article className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 md:p-10">
            <header>
              ...
              <p className="mt-4 text-slate-700 text-base md:text-lg leading-relaxed">
                ...
                <strong> Arno &amp; Co.</strong> (“Arno &amp; Co.”, “we”, “our”,
                “us”). By accessing our site or engaging our services, you agree
                to these Terms. If you are entering into these Terms on behalf
                of a company, you represent that you have authority to bind that
                company.
              </p>
              ...
              <ul className="mt-6 list-disc pl-6 md:pl-8 space-y-3 text-slate-700 text-base md:text-lg">
                ...
                <li>
                  <strong>Fees &amp; Invoices:</strong> Fees and milestones are
                  defined in the SOW or proposal. Invoices are{" "}
                  <strong>due upon receipt</strong> unless otherwise stated.
                  Late payments may <strong>pause work</strong>.
                </li>
                <li>
                  <strong>Warranties &amp; Disclaimers:</strong> We perform work
                  with reasonable skill and care. Except as expressly stated,
                  services and deliverables are provided “<strong>as is</strong>
                  ”. We do not warrant uninterrupted or error-free operation of
                  third-party platforms (e.g., hosting, payment gateways,
                  analytics).
                </li>
                <li>
            ...
            <section id="privacy-policy" className="mt-13 scroll-mt-34">
              ...
              <p className="mt-3 text-slate-700 text-base md:text-lg leading-relaxed">
                ...
                providers, analytics, email services, payment platforms) subject
                to contractual safeguards. Data is retained only as long as
                necessary for the purposes described or as required by law. You
                may request access, correction, or deletion of your personal
                data by contacting{" "}
                <a
              ...
              <ul className="mt-4 list-disc pl-6 md:pl-8 space-y-2 text-slate-700">
                ...
                <li>
                  Use of <strong>reputable processors</strong> with safeguards.
                </li>
                <li>
            ...
            <section id="payment-policy" className="mt-13 scroll-mt-34">
              ...
              <p className="mt-3 text-slate-700 text-base md:text-lg leading-relaxed">
                ...
                month-end for time-and-materials. We accept the payment methods
                stated on the invoice. Work, licenses, and deployments may be{" "}
                <strong>paused for overdue balances</strong>.
              </p>
              <ul className="mt-4 list-disc pl-6 md:pl-8 space-y-2 text-slate-700">
                <li>
            ...
            <section id="refund-policy" className="mt-13 scroll-mt-34">
              ...
              <p className="mt-3 text-slate-700 text-base md:text-lg leading-relaxed">
                Advance payments are <strong>refundable within 24 hours</strong>{" "}
                of payment if no discovery, design, or development work has
                started. Once work begins, refunds may be granted only for{" "}
                <strong>unused, unallocated time</strong> at our discretion.
                Platform fees, third-party charges, and domain/hosting costs are{" "}
                <strong>non-refundable</strong>. To request a refund, email{" "}
                <a
                  href="mailto:support@arnoandco.com"
                  className="underline decoration-slate-300 underline-offset-4 hover:text-slate-900"
                >
