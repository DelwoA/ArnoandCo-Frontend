      ...
      <section className="bg-white rounded-3xl shadow-sm overflow-hidden mb-7 sm:mb-8 md:mb-9 lg:mb-10">
        <div className="p-6 sm:p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 min-[872px]:grid-cols-2 gap-5 md:gap-6 items-stretch">
            ...
            <article className="group h-full rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6 shadow-sm flex flex-col hover:scale-[1.02] transition-all duration-300 ease-in-out">
              <div className="flex items-center gap-3 mb-4">
                <div className="relative flex h-10 w-10 items-center justify-center">
                  <span
                    aria-hidden
                    className="absolute inset-0 rounded-full border bg-[#c0e0f6]/60 border-[#9dcaf0]"
                  />
                  <Clock className="relative text-[#071b31]" size={20} />
                </div>
            ...
            <article className="group h-full rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6 shadow-sm flex flex-col hover:scale-[1.02] transition-all duration-300 ease-in-out">
              <div className="flex items-center gap-3 mb-4">
                <div className="relative flex h-10 w-10 items-center justify-center">
                  ...
                  />
                  <FileBarChart2
                    className="relative text-[#071b31]"
                    size={20}
                  />
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-slate-900">
