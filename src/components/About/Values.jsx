              ...
              <Reveal direction="left">
                <BlueGlow rounded="rounded-2xl">
                  <Card className="group relative bg-slate-50 px-5 pt-8 rounded-2xl border border-slate-200/70 overflow-hidden min-h-[220px] text-left">
                    ...
                    <CardContent className="p-0 px-0 mt-0">
                      <p className="text-sm md:text-base text-slate-600 leading-normal">
                        We ship quickly while maintaining quality, performance,
                        and maintainability.
                      </p>
                    </CardContent>
                  </Card>
              ...
              <Reveal direction="right">
                <BlueGlow rounded="rounded-2xl">
                  <Card className="group relative bg-slate-50 px-5 pt-8 rounded-2xl border border-slate-200/70 overflow-hidden min-h-[220px] text-left">
                    ...
                    <CardContent className="p-0 px-0 mt-0">
                      <p className="text-sm md:text-base text-slate-600 leading-normal">
                        We explore new ideas responsibly—using AI and modern
                        tooling where it creates value.
                      </p>
                    </CardContent>
                  </Card>
                </BlueGlow>
              ...
              <Reveal direction="left">
                <BlueGlow rounded="rounded-2xl">
                  <Card className="group relative bg-slate-50 px-5 pt-8 rounded-2xl border border-slate-200/70 overflow-hidden min-h-[220px] text-left">
                    ...
                    <CardContent className="p-0 px-0 mt-0">
                      <p className="text-sm md:text-base text-slate-600 leading-normal">
                        We work closely with stakeholders and share progress
                        openly from day one.
                      </p>
                    </CardContent>
                  </Card>
