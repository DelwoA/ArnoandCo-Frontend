    ...
    <header className="sticky top-4 z-50 px-4 sm:px-6 lg:px-7">
      <nav>
        ...
        <Popover>
          {/* Pill wrapper */}
          <div
            className="relative mx-auto max-w-[1023px] lg:hidden
               flex items-center justify-between
               rounded-full py-3 px-6
               bg-gradient-to-b from-white/30 via-white/20 to-white/10
               backdrop-blur-md backdrop-saturate-150
               ring-1 ring-white/40 shadow-lg shadow-black/10"
          >
            {/* Logo */}
            <Link to="/">
              <img
          ...
          <PopoverContent
            ...
            className="p-0 overflow-hidden rounded-2xl max-w-[1023px] w-[90vw] bg-gradient-to-b from-white/30 via-white/20 to-white/10 backdrop-blur-md backdrop-saturate-150 ring-1 ring-black/10 shadow-xl"
          >
            <div className="lg:hidden">
              <ul className="flex flex-col gap-1 py-2 text-xl text-slate-800">
                <li>
                  <Link to="/" className="block px-6 py-3 hover:bg-black/5">
                    Home
                  </Link>
                </li>
                <li>
                  <Link
                    to="/about"
                    className="block px-6 py-3 hover:bg-black/5"
                  >
                    About
                  </Link>
                </li>
