...
const ConnectWithUs = () => {
  return (
    <section className="bg-white rounded-2xl border border-black/5 shadow-sm pt-8 pb-10 px-8.5">
      <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-black">
        Connect with Us
      </h3>
      <p className="text-gray-600 mt-1 text-sm mb-4">
        Follow us on social media for the latest updates, product announcements,
        and more.
      </p>
      ...
      <div className="space-y-3">
        ...
        >
          <div className="w-12 h-12 rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300 bg-gradient-to-br from-fuchsia-500 via-pink-500 to-rose-500">
        ...
        >
          <div className="w-12 h-12 bg-[#0A66C2] rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
            <Linkedin className="w-6 h-6 text-white" />
          </div>
          <div>
            <h3 className="font-semibold text-gray-900">LinkedIn</h3>
            <p className="text-sm text-gray-600">Connect with us on LinkedIn</p>
          </div>
        </Link>
