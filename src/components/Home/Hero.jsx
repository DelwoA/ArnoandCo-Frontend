        ...
        <div className="p-8 md:p-12 lg:p-16 flex-1">
          <Reveal direction="up">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-8 max-w-2xl">
              We create websites, apps, and AI solutions that grow your
              business, boost visibility, simplify tasks, and give customers a
              smooth, connected online experience.
            </p>
            <Link
              to="/contact"
