      ...
      <section className="bg-white rounded-3xl shadow-sm overflow-hidden mb-7 sm:mb-8 md:mb-9 lg:mb-10">
        <div className="p-6 sm:p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 md:gap-6 items-stretch">
            {/* Card: Indexed pages */}
            <BlueGlow scale="hover:scale-[1.03]">
              <article className="h-full rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6 shadow-sm flex flex-col text-center transition-all duration-300">
                {/* Icon */}
